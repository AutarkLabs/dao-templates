...
const ReputationOracleTemplate = artifacts.require('ReputationOracleTemplate')
...
contract('Reputation', ([_, owner, holder1, holder2]) => {
  let daoID, template, dao, acl, ens, tokenReceipt, instanceReceipt
  ...
  before('fetch reputation template and ENS', async () => {
    ...
    ens = ENS.at(registry)
    template = ReputationOracleTemplate.at(address)
  })
